        ...
        <>
            ...
            <section className="flex lg:flex-row flex-col items-center md:max-h-[500px] max-h-[448px] gap-0 lg:gap-6 lg:px-5 mt-4 md:mt-0">
                <section className="md:text-left text-center">
                    ...
                    <p className="text-body-16 lg:text-title-20 lg:mt-4 text-typo-primary">Learn Crypto and Blockchain with Hakifi Blog:
                ...
                <Image
                    ...
                    width={500}
                    height={500}
                    className="object-contain size-full lg:max-h-[550px] max-h-[263px] mt-[38px] md:mt-0"
                    alt="bg"
                />
            </section>
