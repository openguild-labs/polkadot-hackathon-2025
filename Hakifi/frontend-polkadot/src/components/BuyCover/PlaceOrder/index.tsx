...
const Watcher = ({ symbol, pair }: WatcherProps) => {
  ...
  useEffect(() => {
    ...
    if (!p_open || !p_claim || !margin) return;
    ...
    // console.log({ margin, p_claim, period, p_open, side, unit, periodUnit });
  }, [margin, p_claim, period, p_open, side, unit, periodUnit]);
