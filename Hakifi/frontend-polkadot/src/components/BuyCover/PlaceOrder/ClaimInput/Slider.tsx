            ...
            <div className="flex">
                ...
                <div style={{ width: `${100 - rstyleMin}%` }} className="relative pr-1.5 p-claim-slider [&>.rc-slider-mark]:text-body-14 [&>.rc-slider-mark-text-active]:bg-background-tertiary [&>.rc-slider-mark-text-active]:z-20">
                    <SliderWrapper
                        ...
                        railStyle={
                            {
                                backgroundColor: colors.background.quaternary, height: 4, width: '101.5%',
                            }
                        }
                        trackStyle={
                            {
                        ...
                        dotStyle={
                            {
                                ...
                                height: 12,
                                bottom: -4,
                                background: colors.background.quaternary, borderColor: colors.background.quaternary, borderWidth: 1,
                                borderRadius: 1
                            }
                        }

                        activeDotStyle={{
                            background: colors.support.slider,
                            borderColor: colors.support.slider,
                        }}
