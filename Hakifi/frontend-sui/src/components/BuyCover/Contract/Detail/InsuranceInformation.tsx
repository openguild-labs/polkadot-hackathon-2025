...
export const OpeningInsurance = ({ insurance, className }: InsuranceProps) => {
    ...
    return <section className={cn("flex flex-col gap-4", className)}>
        ...
        <div className="flex items-center justify-between text-body-14">
            <TooltipCustom
                content={<p>Value of spot asset or derivative volume</p>}
                title={<p className="text-body-14 !text-typo-secondary border-b border-dashed border-divider-secondary">Insured Value</p>}
                showArrow={true}
            />
