...
use bifrost_core::btc_light_client::Block as bifrostOptimizedBlock;
use bifrost_core::sha256_merkle::{hash_pairs, MerkleProofStep};
...
pub trait AsbifrostOptimizedBlock {
    fn as_bifrost_optimized_block(&self, height: u64) -> bifrostOptimizedBlock;
    fn as_bifrost_optimized_block_unsafe(&self) -> bifrostOptimizedBlock;
}

impl AsbifrostOptimizedBlock for bitcoin::Block {
    fn as_bifrost_optimized_block(&self, height: u64) -> bifrostOptimizedBlock {
        bifrostOptimizedBlock {
            height,
