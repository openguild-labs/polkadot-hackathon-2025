...
use bifrost_core::lp::LiquidityReservation;
use crypto_bigint::{NonZero, U256};
use std::str::FromStr;

// Assuming you have a crate named `bifrost_lib` with these types
...
pub fn get_chainworks(blocks: &[bifrostOptimizedBlock], initial_chainwork: U256) -> Vec<U256> {
...
pub fn build_bifrost_payment_transaction(
    order_nonce: [u8; 32],
