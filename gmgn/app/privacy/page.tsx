  ...
  return (
    <div className="flex flex-col gap-6 p-4 w-screen md:w-[768px]">
      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <li>
          Website refers to GMGN.app, accessible from{" "}
          <a href="https://www.GMGN.app">https://www.GMGN.app</a>
        </li>
        <li>
      ...
      <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
        As a visitor to the GMGN.app website
      </h4>
      <p>
        The privacy of our website visitors is important to us so we do not
        track any individual people. As a visitor to the GMGN.app website:
      </p>
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
